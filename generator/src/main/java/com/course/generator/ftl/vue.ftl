    ...
    <div>
        ...
        <table id="simple-table" class="table  table-bordered table-hover">
            ...
            <tr v-for="${domain} in ${domain}s">
                <#list fieldList as field><#if field.nameHump!="createdAt" && field.nameHump!="updatedAt"><#if field.enums>
                <td>{{${field.enumsConst} | optionKV(${domain}.${field.nameHump})}}</td><#else>
                <td>{{${domain}.${field.nameHump}}}</td></#if></#if></#list>
                <td>
        ...
        methods: {
            ...
            list(page) {
                ...
                self.$ajax.post(process.env.VUE_APP_SERVER + '/${module}/admin/${domain}/list', {
                    ...
                    self.${domain}s = resp.content.list;
